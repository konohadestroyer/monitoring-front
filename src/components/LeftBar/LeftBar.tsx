    ...
    return (
        <div className={classes.LeftBar} style={lightStyleBar}>
                <a className={classes.Button} href="/home">
                    <img src={isLight ? bellLight : ''} className={classes.PngIcon}/>
                </a>
                <div style={{
                    display: 'flex',
                    flexDirection: 'column',
                    ...
                    <a className={classes.Button} href="/home">
                        <img src={isLight ? logoIconLight : logoIcon} className={classes.PngIcon}/>
                    </a>
                    <a className={classes.Button} href="/graph">
                        <img src={isLight ? graphIconLight : graphIcon} style={{
                            width: '35px',
                            height: '35px',
                        }} className={classes.PngIcon} />
                    </a>
                    <a className={classes.Button} href="/admin">
                        <img src={isLight ? adminIconLight : adminIcon} className={classes.PngIcon} />
                    </a>
                </div>                           
        </div>
    )
